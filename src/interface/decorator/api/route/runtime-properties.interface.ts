...
import type { TApiRouteCustomDtoProperties } from "@type/decorator/api/route";
...
export interface IApiRouteRuntimeProperties<E extends IApiBaseEntity, R extends EApiRouteType | undefined = EApiRouteType | undefined> {
	...
	dto?: R extends EApiRouteType ? IApiControllerPropertiesRouteWithDto<E, R>["dto"] : TApiRouteCustomDtoProperties;
