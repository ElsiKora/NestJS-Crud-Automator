export { type IApiFunctionCreateExecutorProperties } from "./create-executor-properties.interface";
export { type IApiFunctionCustomProperties } from "./custom-properties.interface";
