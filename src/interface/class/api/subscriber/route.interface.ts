...
export interface IApiSubscriberRoute<E extends IApiBaseEntity, TAuthorizationExpectation extends EApiRouteSubscriberAuthorizationExpectation = EApiRouteSubscriberAuthorizationExpectation.OPTIONAL, M extends EApiControllerGetListQueryPaginationMode = EApiControllerGetListQueryPaginationMode.PAGE> extends IApiSubscriber {
	...
	onAfterErrorGetList?(context: IApiSubscriberRouteErrorExecutionContext<E, IApiSubscriberRouteExecutionContextDataExtended<E, TApiControllerGetListResponse<E, M>, M>>, error: Error): Promise<void>;
	...
	onAfterGetList?(context: IApiSubscriberRouteExecutionContext<E, TApiControllerGetListResponse<E, M>, IApiSubscriberRouteExecutionContextDataExtended<E, TApiControllerGetListResponse<E, M>, M>>): Promise<TApiControllerGetListResponse<E, M> | undefined>;
	...
	onBeforeErrorGetList?(context: IApiSubscriberRouteErrorExecutionContext<E, IApiSubscriberRouteExecutionContextData<E, TApiControllerGetListResponse<E, M>>>, error: Error): Promise<void>;
