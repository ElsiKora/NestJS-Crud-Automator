...
export interface IApiAuthorizationPolicySubscriber<E extends IApiBaseEntity> {
	...
	getRulesForAction<TAction extends string>(action: TAction, context: IApiAuthorizationPolicySubscriberContext<E>): Promise<Array<IApiAuthorizationPolicySubscriberRule<E, TApiAuthorizationPolicyHookResult<TAction, E>>>>;
