...
const readParametersDtoCache: WeakMap<IApiControllerReadPlan, Map<Type<CanActivate> | undefined, Map<IApiControllerPropertiesRouteAutoDtoConfig | undefined, Type<unknown>>>> = new WeakMap<IApiControllerReadPlan, Map<Type<CanActivate> | undefined, Map<IApiControllerPropertiesRouteAutoDtoConfig | undefined, Type<unknown>>>>();
 ...
 * @param {Type<CanActivate>} [currentGuard] - Authentication guard used for field exposure metadata.
 * @returns {Type<unknown>} Cached generated parameters DTO class.
 */
export function DtoGenerateReadParameters<E>(entityMetadata: IApiEntity<E>, method: EApiRouteType, readPlan: IApiControllerReadPlan, dtoConfig?: IApiControllerPropertiesRouteAutoDtoConfig, currentGuard?: Type<CanActivate>): Type<unknown> {
	let guardCache: Map<Type<CanActivate> | undefined, Map<IApiControllerPropertiesRouteAutoDtoConfig | undefined, Type<unknown>>> | undefined = readParametersDtoCache.get(readPlan);
