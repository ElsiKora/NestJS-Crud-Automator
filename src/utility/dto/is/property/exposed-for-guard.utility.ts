 ...
 */
export function DtoIsPropertyExposedForGuard(method: EApiRouteType, propertyMetadata: TApiPropertyDescribeProperties, dtoType: EApiDtoType, currentGuard?: Type<CanActivate>): boolean {
	...
	const guardArray: Array<Type<CanActivate>> = Array.isArray(guards) ? guards : [guards];
