...
export type TApiSubscriberRouteBeforeUpdateContext<E extends IApiBaseEntity> = IApiSubscriberRouteExecutionContext<E, { body: DeepPartial<E> }, IApiSubscriberRouteExecutionContextData<E>>;
