...
export type TApiSubscriberFunctionBeforeGetContext<E extends IApiBaseEntity, Result extends TApiFunctionGetProperties<E> = TApiFunctionGetProperties<E>, TTransactionExpectation extends EApiFunctionSubscriberTransactionExpectation = EApiFunctionSubscriberTransactionExpectation.SUPPORTS> = IApiSubscriberFunctionExecutionContext<E, Result, TApiSubscriberFunctionExecutionContextData<E, TTransactionExpectation>>;
