...
import type { TApiAuthorizationPolicyBeforeGetListResult } from "@elsikora/nestjs-crud-automator";
...
export class UserAccessPolicy extends ApiAuthorizationPolicyBase<UserEntity> {
	onBeforeGetList(context): TApiAuthorizationPolicyBeforeGetListResult<UserEntity> {
