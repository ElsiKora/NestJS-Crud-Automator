...
Plain installation currently resolves the published 2.10 line. This source documentation describes the unreleased 3.0 contract. Pin an exact published 3.0 candidate when it becomes available and follow [Migrating to 3.0](/docs/nestjs-crud-automator/guides/migrating-to-3-0) before adoption.
...
- [Migrating to 3.0](/docs/nestjs-crud-automator/guides/migrating-to-3-0) - Upgrade from the published 2.10 contract
- [3.0 Release Notes](/docs/nestjs-crud-automator/guides/release-notes-3-0) - Review the complete unreleased major scope
