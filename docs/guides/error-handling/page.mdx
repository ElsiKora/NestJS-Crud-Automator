...
import { ApiRouteSubscriber, ApiRouteSubscriberBase, IApiSubscriberRouteErrorExecutionContext } from "@elsikora/nestjs-crud-automator";
...
export class PostErrorSubscriber extends ApiRouteSubscriberBase<PostEntity> {
	async onAfterErrorCreate(context: IApiSubscriberRouteErrorExecutionContext<PostEntity>, error: Error): Promise<void> {
	...
	async onBeforeErrorCreate(context: IApiSubscriberRouteErrorExecutionContext<PostEntity>, error: Error): Promise<void> {
